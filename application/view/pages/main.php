				...
				<div class="container">
					<div class="carousel-caption">
						...
						<div class="col-md-6 slider_right">
							<img src="public/images/cake.png" alt="cake1" />
						</div>
			...
			<div class="item item2">
				<div class="container">
					<div class="carousel-caption">
						...
						<div class="col-md-6 slider_right">
							<img src="public/images/cake1.png" alt="cake1" />
						</div>
						<div class="clearfix"></div>
					</div>
				</div>
			...
			<div class="item item3">
				<div class="container">
					<div class="carousel-caption">
						...
						<div class="col-md-6 slider_right">
							<img src="public/images/cake2.png" alt="cake1" />
						</div>
						<div class="clearfix"></div>
					</div>
				</div>
			...
			<div class="item item4">
				<div class="container">
					<div class="carousel-caption">
						...
						<div class="col-md-6 slider_right">
							<img src="public/images/cake3.png" alt="cake1" />
						</div>
						<div class="clearfix"></div>
					</div>
					</div>
	...
	<div class="container">
		<div class="col-md-6 welcome-w3lright">
			<div class="video-grid-single-page-agileits">
				<div data-video="qvtjaAW3m-E" id="video"> <img src="public/images/about.png" alt="" class="img-responsive" /> </div>
			</div>
		</div> 
			...
			<div class="agileits_team_grids">
				...
				<div class="agileits_team_grid">
					<div class="agileits_team_grid_figure">
						<!--<img src="public/images/chef1.jpg" alt=" " class="img-responsive" />-->
                        <img src="public/images/me/teamlead.jpg" alt=" " class="img-responsive" />
					</div>
					<!--<h4>Jane Robert</h4>-->
                    <h4>Our teamlead</h4>
				...
				<div class="agileits_team_grid">
					<div class="agileits_team_grid_figure">
						<!--<img src="public/images/chef2.jpg" alt=" " class="img-responsive" />-->
                        <img src="public/images/me/security.jpg" alt=" " class="img-responsive" />
					</div>
				    <!--<h4>James Doe</h4>-->
                    <h4>Our security</h4>
					<div class="social-icon">
				...
				<div class="agileits_team_grid">
					<div class="agileits_team_grid_figure">
						<img src="public/images/me/designer.jpg" alt=" " class="img-responsive" />
					</div>
					<!--<h4>Laura Olivia</h4>-->
                    <h4>Our designer</h4>
					<div class="social-icon">
				...
				<div class="agileits_team_grid">
					<div class="agileits_team_grid_figure">
						<!--<img src="public/images/chef4.jpg" alt=" " class="img-responsive" />-->
                        <img src="public/images/me/secretary.jpg" alt=" " class="img-responsive" />
					</div>
					<!--<h4>William James</h4>-->
                    <h4>Our secretary</h4>
					<div class="social-icon">
							...
							<div class="banner-wrap">
								<div class="testimonials-grid">
									<div class="testimonials-grid-left">
										<img src="public/images/man.png" alt=" " class="img-responsive" />
									</div>
...
<!--    <script>
    ...
    <!--Login and registration field check-->

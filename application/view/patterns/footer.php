        ...
        <div class="w3_agile_footer_grids">
            ...
            <div class="col-md-3 col-xs-6 w3_agile_footer_grid">
                ...
                <ul class="agileits_w3layouts_footer_grid_list">
                    <li>
                        ...
                        <a href="/bakeryin/">Home</a>
                    </li>
                    <li>
                        <span class="fa fa-angle-double-right" aria-hidden="true"></span>
                        <a href="/bakeryin/about">About Us</a>
                    </li>
                    <li>
                        <span class="fa fa-angle-double-right" aria-hidden="true"></span>
                        <a href="/bakeryin/services">Services</a>
                    </li>
                    <li>
                        <span class="fa fa-angle-double-right" aria-hidden="true"></span>
                        <a href="/bakeryin/gallery">Gallery</a>
                    </li>
                    <li>
                        <span class="fa fa-angle-double-right" aria-hidden="true"></span>
                        <a href="/bakeryin/contacts">Contact Us</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-3 col-xs-6 w3_agile_footer_grid">
                ...
                <div class="w3_agileits_footer_grid_left">
                    <a href="#">
                        <img src="/bakeryin/public/images/post1.jpg" alt=" " class="img-responsive" />
                    </a>
                </div>
                <div class="w3_agileits_footer_grid_left">
                    <a href="#">
                        <img src="/bakeryin/public/images/post2.jpg" alt=" " class="img-responsive" />
                    </a>
                </div>
                <div class="w3_agileits_footer_grid_left">
                    <a href="#">
                        <img src="/bakeryin/public/images/post3.jpg" alt=" " class="img-responsive" />
                    </a>
                </div>
                <div class="w3_agileits_footer_grid_left">
                    <a href="#">
                        <img src="/bakeryin/public/images/post4.jpg" alt=" " class="img-responsive" />
                    </a>
                </div>
                <div class="w3_agileits_footer_grid_left">
                    <a href="#">
                        <img src="/bakeryin/public/images/post5.jpg" alt=" " class="img-responsive" />
                    </a>
                </div>
                <div class="w3_agileits_footer_grid_left">
                    <a href="#">
                        <img src="/bakeryin/public/images/post6.jpg" alt=" " class="img-responsive" />
                    </a>
                </div>
                <div class="clearfix"> </div>
            </div>
